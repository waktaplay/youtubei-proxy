...
import { generate as generateToken } from "npm:youtube-po-token-generator";
...
const handler = async (request: Request): Promise<Response> => {
  ...
  // Generate a po_token
  if (url.pathname === "/generate_secured_session") {
    return new Response(JSON.stringify(await generateToken()), {
      headers: {
